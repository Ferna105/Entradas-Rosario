    ...
    <PageContainer className="py-10 sm:py-14">
      <div className="mx-auto max-w-3xl">
        ...
        <Card className="space-y-6 p-6 sm:p-8">
          <section className="space-y-3 border-b border-ink-4 pb-6 text-[15px] leading-relaxed text-text-secondary last:border-0 last:pb-0">
            <h2 className="text-lg font-semibold text-text-primary">Qué hacemos</h2>
            <p>
              <strong className="text-text-primary">Entradas Rosario</strong> es una plataforma
          ...
          <section className="space-y-3 border-b border-ink-4 pb-6 text-[15px] leading-relaxed text-text-secondary last:border-0 last:pb-0">
            <h2 className="text-lg font-semibold text-text-primary">Nuestra misión</h2>
            <p>
          ...
          <section className="space-y-3 border-b border-ink-4 pb-6 text-[15px] leading-relaxed text-text-secondary last:border-0 last:pb-0">
            <h2 className="text-lg font-semibold text-text-primary">Para compradores</h2>
            <p>
          ...
          <section className="space-y-3 text-[15px] leading-relaxed text-text-secondary">
            <h2 className="text-lg font-semibold text-text-primary">Para organizadores</h2>
            <p>
